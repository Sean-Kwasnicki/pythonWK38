...
def seq_of_numbers(s):
    # Add a space to the end of the string to handle the final group comparison
    s += ' '
    result = ''
    ...
    for i in range(len(s) - 1):
        ...
        if s[i] == s[i + 1]:
            ...
            # Append the current count and the character to the result
...
# Test cases
print(seq_of_numbers("1211"))  # Expected output: "111221"
print(seq_of_numbers("111221"))  # Expected output: "312211"
print(seq_of_numbers("31131211131221"))  # Expected output: "13211311123113112211"
